...
export const datosSensoresRouter = (io) => {
  ...
  datosSensoresRouter.post("/", (req, res) => DatosSensoresControlador.registrar(req, res, io));
  datosSensoresRouter.get("/sensor/:sensorId", DatosSensoresControlador.obtenerPorSensor);
