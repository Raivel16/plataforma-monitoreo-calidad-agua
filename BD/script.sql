...
INSERT INTO Sensores (Nombre, ParametroID, Modelo, Fabricante, Latitud, Longitud, Descripcion, EstadoOperativo)
VALUES
('Estacion Río A - Puente Norte', 1, 'SEN-PH-100', 'Acme Sensors', -11.987654, -76.945321, 'Sensor pH en puente norte', 1),
('Estacion Río A - Puente Sur', 5, 'SEN-TMP-200', 'Acme Sensors', -11.988000, -76.946000, 'Sensor temperatura en puente sur', 1),
('Estacion Laguna B', 2, 'SEN-TURB-10', 'WaterTech', -11.990000, -76.950000, 'Sensor turbidez en laguna B', 1);
